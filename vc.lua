...
local repositoryUrl = 'https://raw.githubusercontent.com/Mehdi-MMO/mmo-teleports/main/version.txt'
            ...
            if errorCode == 200 then
                ...
                if newestVersion ~= currentVersion then
                    print(string.format(
                        ...
                        currentVersion, newestVersion, 'https://github.com/Mehdi-MMO/mmo-teleports'))
                end
            else
